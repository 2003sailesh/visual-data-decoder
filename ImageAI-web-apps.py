...
def detect_objects_in_video():
    ...
    if request.method == "POST":
        if request.files.get("video"):
            ...
            # ...assign None
            second_plot = "summary_plot_second.png" if os.path.exists(os.path.join(videos_path, "summary_plot_second.png")) else None
            minute_plot = "summary_plot_minute.png" if os.path.exists(os.path.join(videos_path, "summary_plot_minute.png")) else None
            hour_plot = "summary_plot_hour.png" if os.path.exists(os.path.join(videos_path, "summary_plot_hour.png")) else None
